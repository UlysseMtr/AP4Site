...
?>
    <form>
        <h1>Ligue</h1>
        <div align="center">
            <button type="submit" formaction="creerligue.php" formmethod="post">Créer</button>
            <button type="submit" formaction="modifierligue.php" formmethod="post">Modifier</button>
